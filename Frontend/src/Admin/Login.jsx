        ...
        <form action="" className="bg-gray-100 p-10 rounded-2xl mt-2">
          ...
          <div className="p-5 flex justify-between items-center">
            <div className="flex gap-2 justify-center items-center">
              <input type="checkbox" name="rememberme" id="" className="w-4 h-4"/>
              <label htmlFor="rememberme">Remember Me</label>
            </div>
            <a href="" className="text-blue-600 font-medium">Forgot Password?</a>
          </div>
          <button className="bg-cyan-700 w-full text-white p-3 border-2 border-white hover:bg-white hover:text-cyan-700 hover:border-cyan-700 hover:scale-105 transition-all duration-500">LOGIN</button>
        </form>
      </div>
    </div>
  );
